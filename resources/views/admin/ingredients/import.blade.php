            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('supplier.ingredients.import.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="date" class="block text-sm font-medium text-gray-700">Import Date</label>
                        ...
                        <div class="mb-4">
                            <label for="time" class="block text-sm font-medium text-gray-700">Import Time</label>

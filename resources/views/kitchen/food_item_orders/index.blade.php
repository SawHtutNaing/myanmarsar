<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Kitchen Food Item Orders List') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-bold mb-4">Food Item Orders Summary for Kitchen</h3>
                    ...
                    <form action="{{ route('kitchen.food-item-orders.index') }}" method="GET" class="mb-4">
                        ...
                        <div class="mt-4">
                            ...
                            <a href="{{ route('kitchen.food-item-orders.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-gray-800 uppercase tracking-widest hover:bg-gray-300 focus:bg-gray-300 active:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 ml-2">
                                Clear Filters
                            </a>
                        </div>
                    </form>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-4 whitespace-nowrap text-center text-gray-500">
                                            No food item orders found for the kitchen.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>

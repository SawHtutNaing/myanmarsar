<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('ကျွန်ုပ်၏ ဘေလ်ထုတ်မှတ်တမ်းများ') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-bold mb-4">ကျွန်ုပ်၏ ဘေလ်ထုတ်မှတ်တမ်းများကို စစ်ထုတ်ပါ။</h3>
                    ...
                    <h3 class="text-lg font-bold mb-4 mt-6">ကျွန်ုပ်၏ ဘေလ်ထုတ်မှတ်တမ်းသမိုင်း</h3>
